...
function validate_broker_resources() {
  validate_resource_files $submariner_broker_ns 'endpoints.submariner.io' 'Endpoint' '' "$1"
  validate_resource_files $submariner_broker_ns 'clusters.submariner.io' 'Cluster' '' "$1"
  validate_resource_files $submariner_broker_ns 'serviceimports.multicluster.x-k8s.io' 'ServiceImport' '' "$1"
  validate_resource_files $submariner_broker_ns 'endpointslices.discovery.k8s.io' 'EndpointSlice' '' "$1"
}
